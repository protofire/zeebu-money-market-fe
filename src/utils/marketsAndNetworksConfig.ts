...
// Set Test mode by default. For revert this change remove line 27 and uncomment 28-29
...
export function getNetworkConfig(chainId: ChainId | ExtraChainId): NetworkConfig {
 ...
 */
export const getProvider = (chainId: ChainId | ExtraChainId): ProviderWithSend => {
