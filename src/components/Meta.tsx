...
export function Meta({ title, description, imageUrl, timestamp }: MetaProps) {
  return (
    <Head>
      <title>Zeebu - {title}</title>
      <meta name="description" content={description} key="description" />
      <meta property="og:title" content={`Zeebu - ${title}`} key="title" />
      ...
      <meta name="twitter:site" content="@zeebuofficial" key="twittersite" />
      <meta
      ...
      <meta
        name="keywords"
        key="keywords"
        content="Decentralized Finance, Zeebu, DeFi, lending, borrowing, stablecoins, Ethereum, assets, erc-20, smart contracts, open finance, trustless"
      />
      <link rel="apple-touch-icon" href="/zeebu_icon180.png" />
